...
export const metadata: Metadata = {
  title: 'Thank You Card Wording After a Funeral: Examples & What to Write',
  description:
    'Struggling to write thank you notes after a funeral? Real examples and guidance on what to say to those who attended, sent flowers, donated, or offered support.',
  alternates: { canonical: 'https://www.lastingwords.ai/blog/thank-you-card-wording-after-funeral' },
}

export default function ThankYouCardWording() {
  return (
    <article className="max-w-2xl mx-auto px-6 py-16">
      ...
      <h1 className="text-3xl md:text-4xl font-serif text-stone-800 mb-4 leading-snug">
        Thank You Card Wording After a Funeral: Examples & What to Write
      </h1>
      ...
      <div className="prose prose-stone max-w-none text-stone-700 leading-relaxed space-y-6">
        <p>
          Writing thank you notes after a funeral is one of those tasks that feels small on a list and enormous in practice. You're exhausted from grief, and you're being asked to find gracious, heartfelt words for dozens of people — each of whom showed up for you in a different way.
        </p>
        <p>
          The examples and guidance below are meant to make this easier. Use them as starting points, personalizing as you're able.
        </p>
        ...
        <p>
          LastingWords includes a personalized thank you card message as part of every tribute package. It's written from what you share about your loved one — so it feels like you, not a form letter. And it's ready in minutes alongside the obituary, eulogy, and everything else you need.
        </p>
      </div>

      <div className="mt-12 p-6 bg-stone-50 rounded-xl border border-stone-200">
        <h3 className="font-serif text-stone-800 text-lg mb-2">Get a personalized thank you message written for you</h3>
        <p className="text-stone-600 text-sm mb-4">
          LastingWords includes a thank you card message with every order — along with an obituary, eulogy, memorial program, and social announcement. $39 for the complete package.
        </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Thank You Card Wording After a Funeral: Examples & What to Write',
